...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    output: {
      // The build folder.
      path: isEnvProduction ? paths.appBuild : path.join(__dirname, '../build'),
      // Add /* filename */ comments to generated require()s in the output.
      pathinfo: isEnvDevelopment,
      // There will be one main bundle, and one file per asynchronous chunk.
      // In development, it does not produce real files.
      filename: isEnvProduction ?
        'static/js/[name].[contenthash:8].js' : 'static/js/bundle.js',
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction ?
        'static/js/[name].[contenthash:8].chunk.js' : 'static/js/[name].chunk.js',
      // We inferred the "public path" (such as / or /my-project) from homepage.
      // We use "/" in development.
      // In this app, the public directory will always be /public
      publicPath: '/public/',
          ...
          oneOf: [
            ...
            // Unlike the application JS, we only compile the standard ES features.
            {
              ...
              options: {
                ...
                sourceMaps: isEnvDevelopment ? true : false,
              },
            },
